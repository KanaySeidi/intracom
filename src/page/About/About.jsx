    ...
    <>
      <div className={about.section} id="about">
        <div className={about.container}>
          <h2 className={about.mainText}>О нас</h2>
          <p className={about.text}>
            Добро пожаловать в компанию{" "}
            <span className={about.intra}>ИНТРАКОМ</span> – вашего надежного
            партнера в мире информационных технологий. Мы специализируемся на
            предоставлении полного спектра IT-услуг, чтобы удовлетворить все
            ваши потребности в области информационных технологий. Наша компания
            предоставляет экспертное сопровождение в следующих направлениях:
            <ul>
              <li>
                Поставки серверного оборудования: Мы предлагаем широкий выбор
                серверных решений, обеспечивая надежность и производительность
                для вашего бизнеса.
              </li>
              <li>
